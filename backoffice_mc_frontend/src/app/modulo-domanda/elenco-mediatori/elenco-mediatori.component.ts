...
export class ElencoMediatoriComponent implements OnInit {
  ...
  loadTableMG() {
    ...
    this.serviceME.getAllAnagraficaMediatoriA('anagrafica/getAllAnagraficaMediatoriA', params).subscribe({
      next: (res: any) => {
  ...
  attivaRicercaMG() {
    ...
    this.serviceME
      .getAllAnagraficaMediatoriA('anagrafica/getAllAnagraficaMediatoriA', params)
      .subscribe((res: any) => {
        this.tableResultMG = res.result;
        this.totalPageMG = Math.ceil(res.totalResult / 10);
        this.totalResultMG = res.totalResult;
  ...
  loadTableII() {
    ...
    this.serviceME.getAllAnagraficaMediatoriB('anagrafica/getAllAnagraficaMediatoriB', params).subscribe({
      next: (res: any) => {
  ...
  attivaRicercaII() {
    ...
    this.serviceME
      .getAllAnagraficaMediatoriB('anagrafica/getAllAnagraficaMediatoriB', params)
      .subscribe((res: any) => {
        this.tableResultII = res.result;
        this.totalPageII = Math.ceil(res.totalResult / 10);
        this.totalResultII = res.totalResult;
  ...
  loadTableMC() {
    ...
    this.serviceME.getAllAnagraficaMediatoriC('anagrafica/getAllAnagraficaMediatoriC', params).subscribe({
      next: (res: any) => {
  ...
  attivaRicercaMC() {
    ...
    this.serviceME
      .getAllAnagraficaByIdRichiestaForEleCompOrgAm('anagrafica/getAllAnagraficaMediatoriC', params)
      .subscribe((res: any) => {
        this.tableResultMC = res.result;
        this.totalPageMC = Math.ceil(res.totalResult / 10);
        this.totalResultMC = res.totalResult;
  ...
  openPdfFile() {
    ...
    this.serviceME.getAnteprimaFileAutocertificazioneReqOno('pdf/getAnteprimaFileElencoMediatori', params)
      .subscribe({
        next: (res: any) => {
  ...
  convalidazione() {
    ...
    this.serviceME.validazioneElencoMediatore('status/convalidazioneElencoMediatori', params).subscribe({
      next: (res: any) => {
        this.sharedService.onUpdateMenu();
        this.loadIsConvalidato();
  ...
  validazione() {
    ...
    this.serviceME
      .validazioneElencoMediatori('status/validaElencoMediatori', params)
      .subscribe({
        next: (res: any) => {
          this.sharedService.onUpdateMenu();
          this.loadIsConvalidato();
  ...
  annullazione() {
    ...
    this.serviceME
      .annullaElencoRapLegAndRespOrg('status/annullaElencoMediatori', params)
      .subscribe({
        next: (res: any) => {
          this.sharedService.onUpdateMenu();
          this.loadIsConvalidato();

...
export class AutocertificazioneOnorabilitaComponent implements OnInit {
  ...
  loadSelectResponsabili() {
    ...
    this.serviceME
      .getAllRappresentantiAutocertificazioni(
        "anagrafica/getAllRappresentantiAutocertificazioni",
        params
      )
      .subscribe((res: any) => {
  ...
  openPdfFile() {
    ...
    this.serviceME
      .getAnteprimaFileAutocertificazioneRapLRespO(
        "pdf/getAnteprimaFileAutocertificazione",
        params
      )
      .subscribe({
        next: (res: any) => {
  ...
  loadOnorabilitaIsConvalidato() {
    const params = new HttpParams()
      ...
      .set("idAnagrafica", this.idAnagrafica)
      .set(
        "convalidaAnagraficaRapLegale",
        this.anagraficaRapLegClone != null &&
          this.anagraficaRapLegClone.codiceFiscale == this.codiceFiscale
          ? true
          : false
      );

    this.serviceME
      .getStatusRquisitiOnorabilita("status/getStatusReqOno", params)
      .subscribe({
        next: (res: any) => {
  ...
  convalidazione() {
    ...
    this.serviceME
      .convalidazioneRquisitiOnorabilita(
        "status/convalidazioneRequisitiOnorabilita",
        params
      )
      .subscribe({
        next: (res: any) => {

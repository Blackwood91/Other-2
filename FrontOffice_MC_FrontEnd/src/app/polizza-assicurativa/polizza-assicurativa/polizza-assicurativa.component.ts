...
export class PolizzaAssicurativaComponent implements OnInit {
  ...
  attivaRicerca() {
    ...
    this.serviceME
      .getAllSediOperativeByRichiesta(
        "statoModuli/getAllPolizzaAssicurativa",
        params
      )
      .subscribe((res: any) => {
        this.tableResult = res.result;
  ...
  send() {
    ...
    this.serviceME
      .saveFileAttoCostitutivoOdm(
        "statoModuli/saveFilePolizzaAssicurativa",
        formData
      )
      .subscribe({
        next: (res: any) => {
  ...
  convalidazione() {
    ...
    this.serviceME
      .convalidazionePolizzaAssicurativa(
        "status/convalidazionePolizzaAssicurativa",
        params
      )
      .subscribe({
        next: (res: any) => {
  ...
  updateFileModulo(selectedFilePDF: any, id: number) {
    ...
    this.serviceME
      .saveFileAttoCostitutivoOdm("statoModuli/updateFilePolizza", formData)
      .subscribe({
        next: (res: any) => {
          this.isModifica = false;
          this.loadTable();
  ...
  checkAlreadyInserito() {
    ...
    this.serviceME.isConvalidato("statoModuli/getPolizzaIsInserita", params)
    .subscribe({
      next: (res: any) => {

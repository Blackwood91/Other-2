...
<div class="footer-space-top"></div>
        ...
        <div class="row clearfix">
             <div class="col-sm-12">
               <div class="it-brand-wrapper">
                 <a href="https://www.esteri.it/it/" class="">
                   <img class="mr-3 footer-logo" src="https://www.esteri.it/wp-content/uploads/2021/04/cropped-ministero_affari_esteri_logo.png" alt="Logo Ministero degli Affari Esteri e della Cooperazione Internazionale">
		  ...
		  <div class="flag_container clearfix logo-flag">
                     ...
                     <h2 class="no_toc footer-title">Ministero degli Affari Esteri<br> e della Cooperazione Internazionale</h2>
                   </div>
                 </a>
               </div>
             </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 pb-2">
            ...
            <form action="#" class="form-newsletter" method="post">
              <label class="text-white fw-semibold mb-2" for="input-newsletter">Iscriviti per riceverla</label>
              <input class="form-control" id="input-newsletter" name="input-newsletter" placeholder="mail@example.com" type="email" />
              <button class="btn btn-primary btn-icon" type="submit">
                <svg class="icon icon-white">
                  <use xlink:href="{{ site.baseurl }}/dist/svg/sprites.svg#it-mail"></use>
                </svg>
                <span>Iscriviti</span>
              </button>
            </form>
                ...
                <a class="p-2 text-white" href="#" target="_blank">
                  <svg class="icon icon-sm icon-white align-top">
                    <use
                      xlink:href="{{
                        site.baseurl
                      }}/dist/svg/sprites.svg#it-designers-italia"
                    ></use>
                  </svg>
                ...
                <a class="p-2 text-white" href="#" target="_blank">
                  <svg class="icon icon-sm icon-white align-top">
                    <use
                      xlink:href="{{
                        site.baseurl
                      }}/dist/svg/sprites.svg#it-twitter"
                    ></use>
                  </svg>
                ...
                <a class="p-2 text-white" href="#" target="_blank">
                  <svg class="icon icon-sm icon-white align-top">
                    <use
                      xlink:href="{{
                        site.baseurl
                      }}/dist/svg/sprites.svg#it-medium"
                    ></use>
                  </svg>
                ...
                <a class="p-2 text-white" href="#" target="_blank">
                  <svg class="icon icon-sm icon-white align-top">
                    <use
                      xlink:href="{{
                        site.baseurl
                      }}/dist/svg/sprites.svg#it-behance"
                    ></use>
                  </svg>

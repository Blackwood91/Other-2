...
export class AutocertificazioneOnorabilitaCompOrgAmComponent implements OnInit {
  ...
  loadSelectCompOrgAm() {
    ...
    this.serviceME.getAllSelectAutocertReqOnoForCompOrgAm('anagrafica/getAllSelectAutocertReqOnoForCompOrgAm', params)
      .subscribe((res: any) => {
  ...
  openPdfFile() {
    ...
    this.serviceME.getAnteprimaFileAutocertificazioneReqOno('pdf/getAnteprimaFileAutocertificazioneReqOnoCompOrgAm', params)
      .subscribe({
        next: (res: any) => {
  ...
  loadOnorabilitaIsConvalidato() {
    ...
    this.serviceME.getStatusRquisitiOnorabilita('status/getStatusReqOnoCompOrgAm', params)
      .subscribe({
        next: (res: any) => {
  ...
  validazione() {
    ...
    this.serviceME
      .validazioneRequisitiOnorabilitaCompOrgAm('status/validazioneRequisitiOnorabilitaCompOrgAm', params)
      .subscribe({
        next: (res: any) => {
  ...
  annullazione() {
    ...
    this.serviceME
      .annullaRequisitiOnorabilitaCompOrgAm('status/annullaRequisitiOnorabilitaCompOrgAm', params)
      .subscribe({
        next: (res: any) => {
          this.sharedService.onUpdateMenu();
          this.loadOnorabilitaIsConvalidato();

...
@NgModule({
  declarations: [
    ...
    ElencoRichiesteIscrizioneComponent,
    ElencoTotaleUtentiComponent,
    RichiestaIntegrazioneComponent,
    RichiesteRegistrazioneUtenteComponent,
    RichiesteInviateComponent,
    EmissionePdgComponent,
    LetturaPdgComponent,
    PaginaInfoComponent,
    EsitoLogoutComponent,
  ],
  imports: [
    BrowserModule,
    FormsModule,

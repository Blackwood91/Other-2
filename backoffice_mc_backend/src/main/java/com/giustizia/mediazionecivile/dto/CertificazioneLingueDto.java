...
public class CertificazioneLingueDto {
	private Long idStatoModRicFigl;
	...
	public Long getIdStatoModRicFigl() {
		return idStatoModRicFigl;
	}

	public void setIdStatoModRicFigl(Long idStatoModRicFigl) {
		this.idStatoModRicFigl = idStatoModRicFigl;
	}

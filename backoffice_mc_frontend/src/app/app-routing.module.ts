...
import { ElencoRichiesteIscrizioneComponent } from './elenco-richieste-iscrizione/elenco-richieste-iscrizione.component';
import { ElencoTotaleUtentiComponent } from './elenco-totale-utenti/elenco-totale-utenti.component';
import { RichiestaIntegrazioneComponent } from './richiesta-integrazione/richiesta-integrazione.component';
import { RichiesteRegistrazioneUtenteComponent } from './richieste-registrazione-utente/richieste-registrazione-utente.component';
import { EmissionePdgComponent } from './emissione-pdg/emissione-pdg.component';
import { PaginaInfoComponent } from './pagina-info/pagina-info.component';
import { EsitoLogoutComponent } from './esito-logout/esito-logout.component';
...
const routes: Routes = [
  ...
  { path: 'homePage', component: ElencoRichiesteIscrizioneComponent },
  ...
  { path: 'elencoRichiesteIscrizioni', component: ElencoRichiesteIscrizioneComponent},
  { path: 'richiestaIntegrazione', component: RichiestaIntegrazioneComponent},
  { path: 'richiesteRegistrazioneUtente', component: RichiesteRegistrazioneUtenteComponent},
  { path: 'utenti', component: ElencoTotaleUtentiComponent},
  { path: 'emissionePdg', component: EmissionePdgComponent},
  { path: 'paginaInfo', component: PaginaInfoComponent},
  { path: 'esitoLogout', component: EsitoLogoutComponent },

...
export class SchedaAnagraficaRappresentantiComponent implements OnInit {
  ...
  openModal(idRichiesta: number, idAnagrafica: number, visibleRadioIsEqualRapLeg: boolean, updateAnagraficaRapLegale: boolean) {
  ...
  resetFile() {
      ...
      const fileInput = <HTMLInputElement>document.getElementById('allegatoDocumento');
      const fileInput2 = <HTMLInputElement>document.getElementById('qualificaDiMediatore');
  ...
  loadIsConvalidato() {
    const params = new HttpParams()
      .set('idRichiesta', this.idRichiesta)
      .set('idAnagrafica', this.idAnagrafica)
      .set('isCloneAnagraficaRapLegale', this.updateAnagraficaRapLegale);

    this.serviceME
      .getStatusRapLegOrRespOrOrgAm('status/getStatusRapLegOrRespOrOrgAm', params)
      .subscribe({
        next: (res: any) => {
  ...
  validazione() {
    ...
    this.serviceME
      .validazioneRapLegAndRespOrg('status/validazioneRapLegAndRespOrg', params)
      .subscribe({
        next: (res: any) => {
  ...
  annullazione() {
    ...
    this.serviceME
      .annullaRapLegAndRespOrg('status/annullaRapLegAndRespOrg', params)
      .subscribe({
        next: (res: any) => {

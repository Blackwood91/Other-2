...
export class OnorabilitaAppendiciComponent implements OnInit {
  ...
  loadSelectMediatori() {
    ...
    switch (this.component) {
      case "onorabilita-a":
        this.serviceME.getAllAnagrafica('anagrafica/getAllAutocertificazioneMediatoriA', params)
          .subscribe({
            next: (res: any) => {
        ...
        break;
      case "onorabilita-b":
        this.serviceME.getAllAnagrafica('anagrafica/getAllAutocertificazioneMediatoriB', params)
          .subscribe({
            next: (res: any) => {
              this.mediatori = res.result;
              this.idModulo = 44;
        ...
        break;
      case "onorabilita-c":
        this.serviceME.getAllAnagrafica('anagrafica/getAllAutocertificazioneMediatoriC', params)
          .subscribe({
            next: (res: any) => {
              this.mediatori = res.result;
              this.idModulo = 53;
  ...
  openPdfFile() {
    ...
    this.serviceME.getAnteprimaFileAutocertificazioneReqOno('pdf/' + apiPath, params)
      .subscribe({
        next: (res: any) => {
  ...
  validazione() {
    ...
    this.serviceME
      .validazioneRequisitiOnorabilitaAppendici('status/validazioneRequisitiOnorabilitaAppendici', params)
      .subscribe({
        next: (res: any) => {
  ...
  annullazione() {
    ...
    this.serviceME
      .annullaRequisitiOnorabilitaAppendici('status/annullaRequisitiOnorabilitaAppendici', params)
      .subscribe({
        next: (res: any) => {
          this.sharedService.onUpdateMenu();
          this.loadOnorabilitaIsConvalidato();

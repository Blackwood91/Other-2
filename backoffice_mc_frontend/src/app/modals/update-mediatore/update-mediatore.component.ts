...
export class UpdateMediatoreComponent implements OnInit {
  ...
  loadSchedaAnagrafica(): void {
    ...
    this.serviceME.getAnagraficaById('anagrafica/getAnagraficaByIdDto', params)
      .subscribe({
        next: (res: any) => {
  ...
  validazione() {
    ...
    this.serviceME
      .validazioneMediatore('status/validazioneMediatore', params)
      .subscribe({
        next: (res: any) => {
  ...
  annullazione() {
    ...
    this.serviceME
      .annullaMediatore('status/annullaMediatore', params)
      .subscribe({
        next: (res: any) => {
